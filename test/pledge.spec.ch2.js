...
--------------------------------------------------------*/
  ...
  // `then` es el core del comportamiento de las promesas.
  // De hecho, el P/A+ spec que foma los fundamentos del spec de ES6 solo cubre este método.
  // La función `then` es usada para registrar *handlers* si y cuando la promesa se completa o rechaza.
  describe("El método .then de una promesa", function () {
    ...
    // Esto es llamar `then` en la misma promesa multiples veces, el cual no es lo mismo que "chaining".
    // Vamos a ver promise chaining en el Cap. 4.
